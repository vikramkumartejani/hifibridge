               ...
               <div className="relative flex flex-col gap-20 px-4 md:hidden">
                    <div className='flex flex-col w-full gap-8'>
                         ...
                         <div className='flex flex-col gap-4 px-2 m-auto text-center md:text-left'>
                              ...
                              <p className='text-black text-sm font-spacemono'>HIFI provides the infrastructure for moving money across any bank or stablecoin. Build any money movement experience with our API's.</p>
                         </div>
                    </div>
                    <div className='flex flex-col w-full gap-8'>
                         <div>
                         ...
                         <div className='flex flex-col gap-4 px-2 m-auto text-center md:text-left'>
                              ...
                              <p className='text-black text-sm font-spacemono'>Setup a digital account to manage operations in USDC or any stablecoin.</p>
                         </div>
                    </div>
                    <div className='flex flex-col w-full gap-8'>
                         <div>
                         ...
                         <div className='flex flex-col gap-4 px-2 m-auto text-center md:text-left'>
                              <h3 className='text-black text-2xl md:text-4xl '>Connect your company to decentralized ledger technology</h3>
                              <p className='text-black text-sm font-spacemono'>Get started with the fastest payment rails to speed up every aspect of your business - from cash flow to settlement.</p>
                         </div>
                    </div>
                    <div className='flex flex-col w-full gap-8'>
                         <div>
                         ...
                         <div className='flex flex-col gap-4 px-2 m-auto text-center md:text-left'>
                              ...
                              <p className='text-black text-sm font-spacemono'>Accelerate your payments experience with stablecoins, Instant ACH, and RTP to get paid faster.</p>
                         </div>
                    </div>
               </div>
          </div>
